...
return(
    <>
 <div className='main'><h1>Chess Game</h1><br/>
            <p>משחק השחמט הינו אחד ממשחקי החשיבה העתיקים והמרתקים בעולם<br/>
        אמנם הוא הומצא לפני למעלה מאלפיים שנה, אך מצליח להישאר פופולרי גם בימים אלה<br/>
        מחשבי העל של ימינו לא מוצאים דרך לנתח משחקים ולנצח בהם<br/>
        אנחנו חושבים ששח-מט הוא דרך נהדרת להטמעה של כישורים כמו פתרון בעיות, חשיבה מתימטית ועוד</p><br/>
        <br/></div>
